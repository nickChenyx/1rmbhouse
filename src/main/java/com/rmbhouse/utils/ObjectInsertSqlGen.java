 ...
 */
public class ObjectInsertSqlGen {
//    public String insertHouse(Map<String,Object> map){
...
//    }
    ...
    {
        logger.debug("entering ObjectInsertSqlGen.block()");
    }
    public String insertHouse(House house){
        logger.debug("entering ObjectInsertSqlGen.insertHouse()");
